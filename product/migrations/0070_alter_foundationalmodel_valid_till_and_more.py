# Generated by Django 4.2.9 on 2024-03-13 09:01
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('product', '0069_alter_foundationalmodel_valid_till_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='valid_till',
            field=models.DateField(default=datetime.datetime(2025, 3, 13, 9, 1, 55, 50573, tzinfo=datetime.timezone.utc)),
        ),
        migrations.AlterField(
            model_name='product',
            name='valid_till',
