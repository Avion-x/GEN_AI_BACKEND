# Generated by Django 4.2.9 on 2024-02-29 06:19
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('product', '0065_alter_foundationalmodel_valid_till_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='valid_till',
            field=models.DateField(default=datetime.datetime(2025, 2, 28, 6, 19, 16, 131966, tzinfo=datetime.timezone.utc)),
        ),
        migrations.AlterField(
            model_name='product',
            name='valid_till',
