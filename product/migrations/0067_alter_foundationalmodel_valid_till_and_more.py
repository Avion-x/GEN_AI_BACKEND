...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('product', '0066_alter_foundationalmodel_valid_till_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='valid_till',
            field=models.DateField(default=datetime.datetime(2025, 2, 28, 6, 25, 12, 952003, tzinfo=datetime.timezone.utc)),
        ),
        migrations.AlterField(
            model_name='product',
            name='valid_till',
