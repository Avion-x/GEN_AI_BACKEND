# Generated by Django 4.2.9 on 2024-03-13 09:09
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('product', '0071_alter_foundationalmodel_valid_till_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='valid_till',
            field=models.DateField(default=datetime.datetime(2025, 3, 13, 9, 9, 36, 851068, tzinfo=datetime.timezone.utc)),
        ),
        migrations.AlterField(
            model_name='product',
            name='valid_till',
