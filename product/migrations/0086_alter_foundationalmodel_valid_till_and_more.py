...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('product', '0085_remove_knowledgebaseresults_updated_by_and_more'),
        ('user', '0041_alter_accesstype_valid_till_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='request',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='knowledge_base_results', to='user.requesttracking', to_field='request_id'),
        ),
        migrations.AlterField(
            model_name='knowledgebaseresults',
            name='valid_till',
