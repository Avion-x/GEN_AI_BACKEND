...
from .views import CsvFilesandItsColumnsView, LatestTestTypesWithCategoriesOfProduct, TestCasesAndScripts, TestResponse, TestSubCategoryParametersView, TestTypeView, ProductCategoryView, \
    ...
    CategoryDetailsView, TopologyParamterSpecs, UploadDeviceDocsView, EmbedUploadedDocs, UserCreatedTestCasesAndScripts, TestSubCategoriesView, FilterStructuredTestScriptView, UpdateParametersAPI
...
urlpatterns = [
    ...
    path('topology_parameters_specs/', TopologyParamterSpecs.as_view(), name='topology_parameters_specss')
]
